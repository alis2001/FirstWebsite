...
<body style="background-image: url('img/background2.png'); margin: 0;">
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		if (mysqli_query($conn,$insert)) {
			...
			$failure = "Your message has not been sent due to the technical issues. Please try again later";
		}	
		...
		<div id="container3">
			...
			<div id="form_container" class="frame">
				<p class="textstyle" id="form_header">Contact Me</p>
					<form method="POST" action="<?php echo $_SERVER['PHP_SELF'] . "#form_container"; ?>" >
